...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        ...
        <nav>
            ...
            <a href="Orderdetails.php"><button class="nav-link active px-4" id="ongoing-tab" data-bs-toggle="tab" data-bs-target="#nav-ongoing" type="button" role="tab" aria-controls="nav-ongoing" aria-selected="true">&nbsp;Ongoing&nbsp;</button></a>
                        ...
                        <?php while ( $og_row = mysqli_fetch_array($ongoing_result)) { ?>
                            <div class="col">
                                ...
                                <class="text-dark text-decoration-none">
                                    <div class="card mb-3">
                                        <?php if ($og_row["delivery_status"] == "delivered") { ?>
                                            <div class="card-header bg-info text-dark justify-content-between">
                                                <small class="me-auto d-flex" style="font-weight: 500;">Order Completed</small>
                                            </div>
                                        <?php } ?>
                                        <div class="card-body">
