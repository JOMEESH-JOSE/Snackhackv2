...
$oid = $_GET['id'];
$sts = $_GET['sts'];
$main_tb = mysqli_query($conn,"SELECT payment_id,id,P_Amount,P_status,DATE(order_time)as date,TIME(order_time) as time FROM `tbl_payment` WHERE payment_id='$oid'");
...
<div class="ord-inv-cont" >
            <div class="inv-body" id="invoice">
                ...
                <div class="inv-conts">
                    ...
                    <h5>Table No:&nbsp; <?php echo $row['id']; ?></h5>
