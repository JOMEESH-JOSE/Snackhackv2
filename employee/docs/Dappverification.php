...
session_start();
// $bid = $_POST['email'];
$ap1 = mysqli_query($conn, "SELECT * FROM `registration_tb1` join login_tb on login_tb.Lg_id = `registration_tb1`.Lg_id where `registration_tb1`.email = '$em'");
...
<p>Hi,' . $name . '</p>
<p>You have been Approved by admin....!</p>
