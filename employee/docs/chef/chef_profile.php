...
if (isset($_POST['save'])) {
  ...
  $up = mysqli_query($conn, "UPDATE `chef_reg_tb` SET `name`='$name1',`gender`='$genders1',`dob`='$dob1',`image`='$image1',`address`='$address1',`district_id`='$district1',`city_id`='$city1',`pin`='$pin1',`email`='$email1',`phno`='$phno1',`experience`='$experience1',`Expert`='$expert1' WHERE Lg_id='$UserID'");
}
$sql = mysqli_query($conn, "SELECT * FROM `chef_reg_tb` inner join `login_tb` on login_tb.Lg_id = chef_reg_tb.Lg_id join city on city.id=chef_reg_tb.city_id join district on district.id=chef_reg_tb.district_id  where login_tb.Lg_id='$UserID'");
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="user-timeline">
            <div class="timeline-post">
              ...
              <p>District :<?php echo $row['d_name']; ?></p>
              <p>City :<?php echo $row['c_name']; ?></p>
              ...
              <div class="tile user-settings">
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row mb-4">
                    <div class="col-md-4">
                      <label>Phno</label>
                      <input class="form-control" type="number" name="phno" minlenght="10" maxlength="10" value="<?php echo $row['phno']; ?>" oninput="this.value = Math.abs(this.value)">
                    </div>
                    <div class="col-md-4">
                      <label>Experience</label>
                      <input class="form-control" type="number" name="experience" value="<?php echo $row['experience']; ?>">
                    </div>
                    <div class="col-md-4">
                      <label>Expert in </label>
                      <input class="form-control" type="text" name="expert" value="<?php echo $row['Expert']; ?>">
                    </div>
                    <div class="col-md-4">
                      <label>Username</label>
                      <input class="form-control" type="text" name="username" value="<?php echo $row['username']; ?>" readonly onclick="return alrt();">
                    </div>
                    <script>
                      function alrt() {
