...
?>
    ...
    <?php 
      $sqli = "SELECT * FROM `registraion_tb`";
      $qq=mysqli_query($conn,$sqli);
      $count=0;
    ...
    ?>
     <div class="row">
        ...
        <?php 
        $conf = "SELECT * FROM `login_tb` where status='Notactive'";
        $conff = mysqli_query($conn,$conf);
        $c1 = 0;
        while ($confr = mysqli_fetch_array($conff)){
          $c1 = $c1+1;
        }
        ?>
        <div class="col-md-6 col-lg-3">
        ...
        <?php 
        $rev="SELECT * FROM `review_tb`";
        $ree=mysqli_query($conn,$rev);
        $revi=0;
        while ($rr = mysqli_fetch_array($ree)){
        $revi=$revi+1;
        }
        ?>
        <div class="col-md-6 col-lg-3">
