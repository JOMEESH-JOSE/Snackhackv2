...
@$bid = $_POST['email'];
@$Uname =  $_POST['uname'];
// $bid = 'jomeesh111@gmail.com';
// $Uname='cv';

// SELECT * FROM `registration_tb` join login_tb on login_tb.Lg_id = registraion_tb.Lg_id where registraion_tb.email = 'jmj1@gmail.com' AND login_tb.username='cv'
$ap1 = mysqli_query($db, "SELECT * FROM `registration_tb1` join login_tb on login_tb.Lg_id = registration_tb1.Lg_id where registration_tb1.email = '$bid' AND login_tb.username='$Uname'");
