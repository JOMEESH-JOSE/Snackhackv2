...
?>
    <main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Online Order Table</h3>
  ...
  <tbody>
    <?php while($row = mysqli_fetch_array($q1)){?>
      <tr>
      ...
      <td><a href="detail4.php?id=<?php echo $row['payment_id']; ?>"><button class="btn btn-" type="submit">Details</button></a>
      <a href="deliveryassign.php?id=<?php echo $row['payment_id']; ?>"><button class="btn btn-" type="submit">Assign</button></a></td>
