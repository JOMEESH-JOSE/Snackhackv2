...
$sq=mysqli_query($conn,"SELECT * FROM login_tb inner join chef_reg_tb on chef_reg_tb.Lg_id = login_tb.Lg_id where status != 'Rejected'");
?>
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Chef Table</h1>
          <p>Table to display analytical data effectively</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Tables</li>
          <li class="breadcrumb-item active"><a href="view_chef.php">Chef Details</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
                ...
                <tbody>
                  ...
                  while($row = mysqli_fetch_array($sq))
                  {
                    ...
                    <td> <?php if ($row['status'] == 'Blocked') { ?>
                        ...
                        <?php } else { ?>
                            <p><a href="chef_usersts.php?sid=<?php echo $row['Lg_id']; ?>&&sts=2&&eml=<?php echo $emil; ?>"><button class="btn btn-primary">Disable</button></a></p>
                        <?php } ?>
