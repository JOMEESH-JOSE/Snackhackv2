...
session_start();
// $bid = $_POST['email'];
$ap1 = mysqli_query($conn, "SELECT * FROM `registraion_tb` join login_tb on login_tb.Lg_id = registraion_tb.Lg_id where registraion_tb.email = '$em'");
...
<p>Hi,' . $name . '</p>
<p>Your account have been Unblocked by admin....!</p>
<p>You can now successfully Login to your Account and Explore SnackHack World</p>
